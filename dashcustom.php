...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <symbol id="speedometer" viewBox="0 0 16 16">
    ...
    <div class="d-flex flex-column p-3 text-white bg-dark" style="width: 350px;">
        <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
            <img class="bi me-2" id="logo" width="90" height="80"  src="logo4.png"/>
    ...
    <div class="p-3 bg-white" style="width: 100vh">
    ...
    <script src="min.js" integrity="sha384-JEW9xMcG8R+pH31jmWH6WWP0WintQrMb4s7ZOdauHnUtxwoG2vI5DkLtS3qm9Ekf" crossorigin="anonymous"></script>
